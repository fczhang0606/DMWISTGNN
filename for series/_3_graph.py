...
class graphFusion(nn.Module) :
    ...
    # 三个向量融合，构建矩阵
    def forward(self, vec_emb, vec_ftr, vec_fse) :
        # [N, G] + [B, N, G] + [B, N, G]

        batch_size = vec_ftr.shape[0]  # B
        nodes      = vec_ftr.shape[1]  # N
        ...
        # 如何融合三个矩阵？
        adj = adj_sta + adj_dyn + adj_att  # [B, N, N]
...
class graph_constructor(nn.Module) :
    ...
    def forward(self, x) :  # [B, 1, N, W]
        ...
        adj     = self.graph_Fusion(vec_emb, vec_ftr, vec_fse)
