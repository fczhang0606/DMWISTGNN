...
# conda install \
# python=3.8 pytorch==2.0.0 torchvision==0.15.0 torchaudio==2.0.0 pytorch-cuda=11.8 -c pytorch -c nvidia
################################################################
# pip install pandas
# pip install scipy
...
if __name__ == '__main__' :
    ...
    for i in range(1, args.epochs+1) :  # 10000 epochs
        ...
        if epoch_valid_m_mae < min_valid_m_mae :  # 本轮验证集mae下降有效
            ...
            if i < 3 :  # 百轮之内，模型大概率未收敛，只要降低了验证集mae，就认为模型有效
